...
const TopBar = () => {
	...
	return (
		<div className="flex justify-center bg-[#cccccc]">
			<div className={`container px-1 ${s.topbar}`}>
				<div>
					<Link className='hover:underline mx-1 ' to='/'>Track Order </Link>
					<Link className='hover:underline mx-1' to='/'>FAQ's </Link>
					<Link className='hover:underline mx-1' to='/'>Help </Link>
				</div>
